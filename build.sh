...
if [[ ! -f ${CROSS_OVER_LOCAL_FILE}.tar.gz ]]; then
    echo -e "\033[1;32m→ downloading crossover sources...\033[0m"
    ...
    echo -e "\033[1;32m→ extracting crossover sources...\033[0m"
...
echo -e "\033[1;32m→ installing x86_64 dependencies through homebrew...\033[0m"

arch -x86_64 brew update
arch -x86_64 brew upgrade
arch -x86_64 brew install bison mingw-w64 llvm lld gettext gstreamer pkgconfig freetype gnutls molten-vk sdl2

echo -e "\033[1;32m→ configuring wine build...\033[0m"
...
echo -e "\033[1;32m→ building wine, this may take a while...\033[0m"

pushd "${BUILDROOT}"/winecx-${CROSS_OVER_VERSION}
make -j"$(sysctl -n hw.ncpu 2>/dev/null)"
popd

echo -e "\033[1;32m→ installing wine under ${BUILDROOT}...\033[0m"
